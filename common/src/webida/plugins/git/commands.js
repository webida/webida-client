...
define([
    ...
    git,
    gitIcon,
    gitviewlog,     // TODO rename to gitViewLog
    Github,
    difflib,
    diffview
) {
    ...
    */
    ...
    function _clone(selectedPath) {
        require(['text!./layer/clone.html'], function (cloneView) {
            function fetchGitHubURL() {
                ...
                var visitURL = appConfig.dashboardBaseUrl + '/pages/main.html#settings';
                async.waterfall([
                    function (next) {
    ...
    function _compare(gitRootPath, filepath) {
        require(['text!./layer/compare.html',
            ...
            var GIT_DIR = gitRootPath;
            var path = workspace.getSelectedPath();
    ...
    function GitAddCommand(id) {
        GitAddCommand.id = id;
    }
    genetic.inherits(GitAddCommand, Command, {
        execute: function () {
    ...
    function GitUntrackCommand(id) {
        GitUntrackCommand.id = id;
    }
    genetic.inherits(GitUntrackCommand, Command, {
        execute: function () {
            return new Promise(function (resolve) {
    ...
    function GitRemoveCommand(id) {
        GitRemoveCommand.id = id;
    }
    genetic.inherits(GitRemoveCommand, Command, {
        execute: function () {
            return new Promise(function (resolve) {
                var selectedPath = workspace.getSelectedPath();
                if (selectedPath) {
    ...
    function GitCommitCommand(id) {
        GitCommitCommand.id = id;
    }
    genetic.inherits(GitCommitCommand, Command, {
        execute: function () {
            return new Promise(function (resolve) {
                var selectedPath = workspace.getSelectedPath();
                if (selectedPath) {
    ...
    function GitResetToCommitCommand(id) {
        GitResetToCommitCommand.id = id;
    }
    genetic.inherits(GitResetToCommitCommand, Command, {
        execute: function () {
            return new Promise(function (resolve) {
                var selectedPath = workspace.getSelectedPath();
                if (selectedPath) {
    ...
    function GitStashCommand(id) {
        GitStashCommand.id = id;
    }
    genetic.inherits(GitStashCommand, Command, {
        execute: function () {
            return new Promise(function (resolve) {
                var selectedPath = workspace.getSelectedPath();
                if (selectedPath) {
    ...
    function GitUnstashCommand(id) {
        GitUnstashCommand.id = id;
    }
    genetic.inherits(GitUnstashCommand, Command, {
        execute: function () {
            return new Promise(function (resolve) {
                var selectedPath = workspace.getSelectedPath();
                if (selectedPath) {
    ...
    function GitCheckoutCommand(id) {
        GitCheckoutCommand.id = id;
    }
    genetic.inherits(GitCheckoutCommand, Command, {
        execute: function () {
            return new Promise(function (resolve) {
                var selectedPath = workspace.getSelectedPath();
                if (selectedPath) {
    ...
    function GitRebaseCommand(id) {
        GitRebaseCommand.id = id;
    }
    genetic.inherits(GitRebaseCommand, Command, {
        execute: function () {
            return new Promise(function (resolve) {
                var selectedPath = workspace.getSelectedPath();
                if (selectedPath) {
    ...
    function GitMergeCommand(id) {
        GitMergeCommand.id = id;
    }
    genetic.inherits(GitMergeCommand, Command, {
        execute: function () {
            return new Promise(function (resolve) {
                var selectedPath = workspace.getSelectedPath();
                if (selectedPath) {
    ...
    function GitBranchCommand(id) {
        GitBranchCommand.id = id;
    }
    genetic.inherits(GitBranchCommand, Command, {
        execute: function () {
            return new Promise(function (resolve) {
                var selectedPath = workspace.getSelectedPath();
                if (selectedPath) {
     ...
     * Show only commits that are enough to explain how the files that match the specified paths came to be.
     */
    function GitFileHistoryCommand(id) {
        GitFileHistoryCommand.id = id;
    }
    genetic.inherits(GitFileHistoryCommand, Command, {
        execute: function () {
            return new Promise(function (resolve) {
                var selectedPath = workspace.getSelectedPath();
                if (selectedPath) {
     ...
     * Show only commits that are enough to explain how the files that match the specified paths came to be.
     */
    function GitRepositoryHistoryCommand(id) {
        GitRepositoryHistoryCommand.id = id;
    }
    genetic.inherits(GitRepositoryHistoryCommand, Command, {
        exectue: function () {
            return new Promise(function (resolve) {
                var selectedPath = workspace.getSelectedPath();
                if (selectedPath) {
     ...
     * Get and set repository or global options
     */
    function GitConfigureCommand(id) {
        GitConfigureCommand.id = id;
    }
    genetic.inherits(GitConfigureCommand, Command, {
        execute: function () {
            return new Promise(function (resolve) {
                var selectedPath = workspace.getSelectedPath();
                if (selectedPath) {
     ...
     * Update remote refs along with associated objects
     */
    function GitPushCommand(id) {
        GitPushCommand.id = id;
    }
    genetic.inherits(GitPushCommand, Command, {
     ...
     * Download objects and refs from another repository
     */
    function GitFetchCommand(id) {
        GitFetchCommand.id = id;
    }
    genetic.inherits(GitFetchCommand, Command, {
        execute: function (resolve) {
            return new Promise(function (resolve) {
                var selectedPath = workspace.getSelectedPath();
                if (selectedPath) {
     ...
     * Fetch from and integrate with another repository or a local branch
     */
    function GitPullCommand(id) {
        GitPullCommand.id = id;
    }
    genetic.inherits(GitPullCommand, Command, {
        execute: function (resolve) {
            return new Promise(function (resolve) {
                var selectedPath = workspace.getSelectedPath();
                if (selectedPath) {
     ...
     * Manage set of tracked repositories
     */
    function GitRemoteCommand(id) {
        GitRemoteCommand.id = id;
    }
    genetic.inherits(GitRemoteCommand, Command, {
        execute: function (resolve) {
     ...
     * Clone a repository into a new directory
     */
    function GitCloneCommand(id) {
        GitCloneCommand.id = id;
    }
    genetic.inherits(GitCloneCommand, Command, {
        execute: function (resolve) {
            return new Promise(function () {
                var selectedPath = workspace.getSelectedPath();
                if (selectedPath) {
     ...
     * Create a repository into a new directory.
     */
    function GitCreateRepositoryCommand(id) {
        GitCreateRepositoryCommand.id = id;
    }
    genetic.inherits(GitCreateRepositoryCommand, Command, {
        execute: function (resolve) {
            return new Promise(function () {
                var selectedPath = workspace.getSelectedPath();
                if (selectedPath) {
                    ...
                    _createRepo(workspace.getRootPath());
                }
                resolve();
            });
        }
     ...
     * Show what revision and author last modified each line of a file.
     */
    function GitBlameCommand(id) {
        GitBlameCommand.id = id;
    }
    genetic.inherits(GitBlameCommand, Command, {
        execute: function (resolve) {
            return new Promise(function () {
                var selectedPath = workspace.getSelectedPath();
                if (selectedPath) {
     ...
     * Compares files in the working tree and the index.
     */
    function GitCompareCommand(id) {
        GitCompareCommand.id = id;
    }
    genetic.inherits(GitCompareCommand, Command, {
        execute: function (resolve) {
            return new Promise(function () {
                var selectedPath = workspace.getSelectedPath();
                if (selectedPath) {
     ...
     * Show the working tree status.
     */
    function GitStatusCommand(id) {
        GitStatusCommand.id = id;
    }
    genetic.inherits(GitStatusCommand, Command, {
        execute: function (resolve) {
            return new Promise(function () {
                var selectedPath = workspace.getSelectedPath();
                if (selectedPath) {
     ...
     * Initialize, update or inspect submodules.
     */
    function GitUpdateSubmoduleCommand(id) {
        GitUpdateSubmoduleCommand.id = id;
    }
    genetic.inherits(GitUpdateSubmoduleCommand, Command, {
        execute: function (resolve) {
            return new Promise(function () {
                var selectedPath = workspace.getSelectedPath();
                if (selectedPath) {
    ...
    // End - convert menu function

    return {
        GitAddCommand: GitAddCommand,
        GitUntrackCommand: GitUntrackCommand,
        GitRemoveCommand: GitRemoveCommand,
        GitCommitCommand: GitCommitCommand,
        GitResetToCommitCommand: GitResetToCommitCommand,
        GitStashCommand: GitStashCommand,
        GitUnstashCommand: GitUnstashCommand,
        GitCheckoutCommand: GitCheckoutCommand,
        GitRebaseCommand: GitRebaseCommand,
        GitMergeCommand: GitMergeCommand,
        GitBranchCommand: GitBranchCommand,
        GitFileHistoryCommand: GitFileHistoryCommand,
        GitRepositoryHistoryCommand: GitRepositoryHistoryCommand,
        GitConfigureCommand: GitConfigureCommand,
        GitPushCommand: GitPushCommand,
        GitFetchCommand: GitFetchCommand,
        GitPullCommand: GitPullCommand,
        GitRemoteCommand: GitRemoteCommand,
        GitCloneCommand: GitCloneCommand,
        GitCreateRepositoryCommand: GitCreateRepositoryCommand,
        GitBlameCommand: GitBlameCommand,
        GitCompareCommand: GitCompareCommand,
        GitStatusCommand: GitStatusCommand,
        GitUpdateSubmoduleCommand: GitUpdateSubmoduleCommand,
        GitRunCommand: GitRunCommand
    };
});
