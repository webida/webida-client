...
define(['./plugin',
    ...
    function getShortcuts() {
        var desc = {
            ...
            'insertsofttab': 'Tab',
            'jsca-autocomplete': 'JavaScript auto completion',
            'jsca-showreference': 'JavaScript show occurences',
            'jsca-showtype': 'JavaScript show type of variable',
            'jsca-gotodefinition': 'JavaScript go to definition',
            'jsca-jumpback': 'JavaScript jump back to the reference',
            'jsca-rename': 'JavaScript rename variable',
