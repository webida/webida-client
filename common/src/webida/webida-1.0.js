...
/**
* Webida SDK 1.0 for Javascript module.
*
* This module provides JavaScript API's for Webida Auth/ACL/App/FS services.
* @module webida
*/
...
(function (root, factory) {
    ...
    mod.conf = {
        ...
        fsApiBaseUrl: fsServer + '/api/v1/fs',
        authApiBaseUrl: authServer + '/api/v1/oauth',
        appApiBaseUrl: appServer + '/api/v1/apps',
        dbApiBaseUrl: dbServer + '/api/v1/db',
        buildApiBaseUrl: buildServer + '/api/v1/builds',
        aclApiBaseUrl: authServer + '/api/v1',
        userApiBaseUrl: authServer + '/api/v1/users',
        groupApiBaseUrl: authServer + '/api/v1/groups',
    ...
    */
     ...
     * Callback function. If function finished successfully then error is undefined
     *
     * @callback request_callback_with_filesystem_quota
     * @param {module:webida.callback_error} error - Error message. Error message is string or undefined
     * @param {module:webida.quota_info} [quotainfo] - Webida file system quota information.
     * @memberOf module:webida
     */
    ...
    */
    ...
    /**
     * Quota information.
     * @typedef {object} quota_info
     * @property {string} usage - the size of all data in the filesystem in bytes
     * @property {string} limit - the limit of all data in the filesystem in bytes
     * @memberOf module:webida
     */
    ...
    */
    ...
    /**
     * Get the current usage and quota limit of filesystem
     *
     * @since 1.0
     * @method getQuota
     ...
     */
    FileSystem.prototype.getQuota = function (callback) {
        var self = this;
        function restApi() {
            ajaxCall({
                url: mod.conf.fsApiBaseUrl + '/' + self.fsid + '/quota',
                data: null,
                callback: callback
            });
        }
     ...
     *        This value might not be updated up to 1 minute.
     * @memberOf module:webida.FSService.FileSystem
     * @deprecated since version 1.0, Use {@link module:webida.FSService.FileSystem.getQuota}
     */
    // TODO need to be merged with getQuotaLimit because they are always used together. See getQuota, new API.
    FileSystem.prototype.getQuotaUsage = function (callback) {
        this.getQuota(function (e, quota) {
            callback(e, quota !== undefined ? quota.usage : undefined);
        });
        /*var self = this;
        function restApi() {
            ajaxCall({
    ...
    */
    FileSystem.prototype.getQuotaLimit = function (callback) {
        this.getQuota(function (e, quota) {
            callback(e, quota !== undefined ? quota.limit : undefined);
        });
        /*var self = this;
        function restApi() {
            ajaxCall({
    ...
    */
    FileSystem.prototype.exportZip = function (sourceList, fileName) {
        var argument = '?source=' + encodeURIComponent(sourceList.join(';')) +
            '&target=' + encodeURIComponent(fileName);
        var url = mod.conf.fsApiBaseUrl + '/' + this.fsid + '/export/' + argument;
    ...
    */
    FileSystem.prototype.createZip = function (sourceList, target, callback) {
        ...
        function restApi() {
            ...
            ajaxCall({
                url: mod.conf.fsApiBaseUrl + '/' + self.fsid + '/archive',
                type: 'POST',
                data: data,
                callback: callback
            });
    ...
    */
    FileSystem.prototype.extractZip = function (source, target, callback) {
        ...
        function restApi() {
            ...
            ajaxCall({
                url: mod.conf.fsApiBaseUrl + '/' + self.fsid + '/extract',
                type: 'POST',
                data: data,
                callback: callback
            });
    ...
    */
    FileSystem.prototype.searchFiles = function (pattern, where, options, callback) {
        ...
        function restApi() {
            ...
            ajaxCall({
                url: mod.conf.fsApiBaseUrl + '/' + self.fsid + '/search',
                data: data,
                callback: callback
            });
        }
    ...
    * @param {module:webida.path|module:webida.fs_url_path} dest - Destination path or destination url
    * @param {boolean} [recursive=false] - Recursive mode. "true" | "false" (default is "false")
    * @param {module:webida.request_callback} callback -
    *        (error:callback_error) → undefined
    *        <br>If function finished successfully then error is undefined
    * @memberOf module:webida.FSService.FileSystem
    */
    FileSystem.prototype.copy = function (source, dest, recursive, callback) {
        var self = this;
        function restApi() {
            var data = {
                source: source,
            ...
            ajaxCall({
                url: mod.conf.fsApiBaseUrl + '/' + self.fsid + '/copy/',
                type: 'POST',
                data: data,
                callback: callback
            });
    ...
    */
    FileSystem.prototype.createDirectory = function (path, recursive, callback) {
        ...
        function restApi() {
            ...
            ajaxCall({
                url: mod.conf.fsApiBaseUrl + '/' + self.fsid + '/paths/' + path,
                type: 'POST',
                data: data,
                callback: callback
            });
    ...
    */
    FileSystem.prototype.exists = function (path, callback) {
        ...
        function restApi() {
            ...
            ajaxCall({
                url: mod.conf.fsApiBaseUrl + '/' + self.fsid + '/exists',
                data: data,
                callback: callback
            });
        }
    ...
    */
    FileSystem.prototype.isEmpty = function (path, callback) {
        var self = this;
        self.list(path, false, function (e, list) {
            if (e) {
                callback(e);
    ...
    *
    * @method listEx
    * @param {module:webida.path} path - List directory path
    ...
    */
    FileSystem.prototype.stat = function (pathList, callback) {
        var self = this;
        function restApi() {
            var data = { path : pathList.join(';') };

            ajaxCall({
                url: mod.conf.fsApiBaseUrl + '/' + self.fsid + '/stat',
                data: data,
                callback: callback
            });
        }
    ...
    */
    FileSystem.prototype.move = function (oldpath, newpath, callback) {
        ...
        function restApi() {
            ...
            ajaxCall({
                url: mod.conf.fsApiBaseUrl + '/' + self.fsid + '/paths/' + oldpath,
                type: 'PUT',
                data: data,
                callback: callback
            });
    ...
    */
    FileSystem.prototype.lockFile = function (file, callback) {
        ...
        function restApi() {
            //file = encodeURI(file);
            ajaxCall({
                url: mod.conf.fsApiBaseUrl + '/' + self.fsid + '/locks',
                data: {
                    path: file,
                    sessionId: sessionId
                },
    ...
    */
    FileSystem.prototype.getFileLink = function (fileId, callback) {
        ...
        function restApi() {
            ...
            ajaxCall({
                url: mod.conf.fsApiBaseUrl + '/' + self.fsid + '/filelinks/' + fileId,
                callback: callback
            });
        }
    ...
    */
    FileSystem.prototype.getFileLinkByPath = function (filePath, callback) {
        ...
        function restApi() {
            ...
            ajaxCall({
                url: mod.conf.fsApiBaseUrl + '/' + self.fsid + '/filelinks',
                data: {
                    path: filePath
                },
                callback: callback
    ...
    * @param {module:webida.filename} filename - The name of keystore file
    ...
    */
    FileSystem.prototype.registerKeystoreFile = function (filename, keyInfo, data, callback) {
        ...
        function restApi() {
            ...
            ajaxCall({
                url: mod.conf.buildApiBaseUrl + '/keystores/' + filename,
                type: 'POST',
                data: fd,
                callback: callback
            });
    ...
    */
    FileSystem.prototype.getKeystoreList = function (callback) {
        ...
        function restApi() {
            ...
            ajaxCall({
                url: mod.conf.buildApiBaseUrl + '/keystores',
                type: 'GET',
                data: {fsId: self.fsid},
                callback: callback
            });
    ...
    */
    FileSystem.prototype.getMeta = function (path, metaName, callback) {
        ...
        function restApi() {
            ...
            ajaxCall({
                url: mod.conf.fsApiBaseUrl + '/' + self.fsid + '/meta/' + metaName,
                data: { path: path },
                callback: callback
            });
        }
    ...
    * @param {int} validityPeriod - expire time of the alias in seconds
    * @param {module:webida.request_callback_with_alias_info} callback -
    *        (error:callback_error, [aliasInfo:alias_info]) → undefined
    * @memberOf module:webida.FSService.FileSystem
    */
    FileSystem.prototype.addAlias = function (path, validityPeriod, callback) {
        var self = this;
        function restApi() {
            path = encodeURI(path);

            ajaxCall({
                url: mod.conf.fsApiBaseUrl + '/' + self.fsid + '/alias',
                type: 'POST',
                data: {
                    path: path,
    ...
    */
    FileSystem.prototype.deleteAlias = function (aliasKey, callback) {
        ...
        function restApi() {
            ...
            ajaxCall({
                url: mod.conf.fsApiBaseUrl + '/' + self.fsid + '/alias/' + aliasKey,
                type: 'DELETE',
                callback: callback
            });
        }
    ...
    */
    FileSystem.prototype.exec = function (path, info, callback) {
        ...
        function restApi() {
            ...
            ajaxCall({
                url: mod.conf.fsApiBaseUrl + '/' + self.fsid + '/exec',
                type: 'POST',
                data: data,
                callback: callback,
                callbackWithRawData: function (data) {
    ...
    */
    mod.AppService.prototype.isValidDomain = function (domain, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.appApiBaseUrl + '/validate',
                data: { domain: domain },
                callback: callback
            });
        }
    ...
    */
    mod.AppService.prototype.setAppInfo = function (appid, domain, apptype, name, desc, srcurl, callback) {
        function restApi() {
            ...
            ajaxCall({
                url: mod.conf.appApiBaseUrl + '/' + appid,
                type: 'PUT',
                data: data,
                callback: callback
            });
    ...
    */
    mod.AppService.prototype.startApp = function (appid, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.appApiBaseUrl + '/' + appid + '/status/running',
                type: 'PUT',
                callback: callback
            });
        }
    ...
    */
    mod.AppService.prototype.stopApp = function (appid, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.appApiBaseUrl + '/' + appid + '/status/stop',
                callback: callback
            });
        }
    ...
    */
    mod.AppService.prototype.deployApp = function (appid, srcUrl, type, callback) {
        function restApi() {
            ...
            ajaxCall({
                url: mod.conf.appApiBaseUrl + '/' + appid + '/deploy',
                type: 'POST',
                data: data,
                callback: callback
            });
    ...
    */
    mod.AuthService.prototype.updateUser = function (user, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.userApiBaseUrl + '/me',
                type: 'PUT',
                data: user,
                callback: callback
            });
    ...
    */
    ...
    mod.AuthService.prototype.deleteAccount = function (userId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.userApiBaseUrl + '/' + userId,
                type: 'DELETE',
                callback: callback
            });
        }
    ...
    */
    mod.AuthService.prototype.changeMyPassword = function (oldPassword, newPassword, callback) {
        ...
        function restApi() {
            ajaxCall({
                url: mod.conf.userApiBaseUrl + '/me/password',
                type: 'PUT',
    ...
    */
    mod.AuthService.prototype.addNewPersonalToken = function (callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.authApiBaseUrl + '/tokens/me',
                type: 'POST',
                callback: callback
            });
        }
    ...
    */
    mod.AuthService.prototype.deletePersonalToken = function (deleteToken, callback) {
        function restApi() {
            ...
            ajaxCall({
                url: mod.conf.authApiBaseUrl + '/tokens/' + deleteToken,
                type: 'DELETE',
                callback: callback
            });
        }
    ...
    */
    mod.AuthService.prototype.getLoginStatus = function (callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.userApiBaseUrl + '/me/status',
                callback: callback
            });
        }
    ...
    */
    ...
    mod.BuildService.prototype.buildProject = function (profileInfo, platformInfo, cb) {
        function restApi() {
            ...
            ajaxCall({
                url: mod.conf.buildApiBaseUrl + '/run',
                data: data,
                type: 'POST',
                callback: ncb
            });
    ...
    */
    mod.ACLService.prototype.createPolicy = function (policy, callback) {
        ...
        function restApi() {
            ajaxCall({
                url: mod.conf.aclApiBaseUrl + '/policies',
                type: 'POST',
                data: data,
                callback: callback
            });
    ...
    mod.ACLService.prototype.createPolicies = function (pArr, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.aclApiBaseUrl + '/policies',
                type: 'POST',
                data: { policyInfo: JSON.stringify(pArr) },
                callback: callback
            });
        }
    ...
    *
    * @method deletePolicy
    * @param {string} policyId - policy id in policy_info returned by {@link module:webida.ACLService.createPolicy}
    * @param {module:webida.request_callback} callback -
    *        (error:callback_error) → undefined
    *        <br>If function finished successfully then error is undefined
    * @memberOf module:webida.ACLService
    */
    mod.ACLService.prototype.deletePolicy = function (policyId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.aclApiBaseUrl + '/policies/' + policyId,
                type: 'DELETE',
                callback: callback
            });
        }
    ...
    * @memberOf module:webida.ACLService
    */
    mod.ACLService.prototype.updatePolicy = function (policyId, policy, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.aclApiBaseUrl + '/policies/' + policyId,
                data: { policyInfo: JSON.stringify(policy), sessionId: sessionId },
                callback: callback
            });
        }
    ...
    * @memberOf module:webida.ACLService
    */
    mod.ACLService.prototype.assignPolicy = function (idArr, policyId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.aclApiBaseUrl + '/policysubjects',
                data: { policyId: policyId, subjectId: idArr.join(';'), sessionId: sessionId },
                callback: callback
            });
        }
    ...
    * @param {int} id - userId or groupId
    ...
    */
    mod.ACLService.prototype.assignPolicies = function (id, pidArr, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.aclApiBaseUrl + '/policysubjects',
                data: { policyId: pidArr.join(';'), subjectId: id, sessionId: sessionId },
                callback: callback
            });
        }
    ...
    * @memberOf module:webida.ACLService
    */
    mod.ACLService.prototype.removePolicy = function (id, policyId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.aclApiBaseUrl + '/policysubjects',
                data: { policyId: policyId, subjectId: id, sessionId: sessionId },
                callback: callback
            });
        }
    ...
    * @memberOf module:webida.ACLService
    */
    mod.ACLService.prototype.getAssignedUser = function (policyId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.aclApiBaseUrl + '/policies/' + policyId + '/subjects',
                data: {type: 'u'},
                callback: callback
            });
        }
    ...
    * @memberOf module:webida.ACLService
    */
    mod.ACLService.prototype.getAssignedGroup = function (policyId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.aclApiBaseUrl + '/policies/' + policyId + '/subjects',
                data: {type: 'g'},
    ...
    */
    mod.ACLService.prototype.getAuthorizedUser = function (action, resource, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.aclApiBaseUrl + '/subjects',
                data: {
                    authorized: JSON.stringify({action: action, resource: resource}),
                    type: 'u'
                },
                callback: callback
            });
    ...
    */
    mod.ACLService.prototype.getAuthorizedRsc = function (action, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.aclApiBaseUrl + '/subjects/me/policies/resources',
                data: {
                    authorized: JSON.stringify({action: action})
                },
                callback: callback
            });
        }
    ...
    */
    mod.ACLService.prototype.getAssignedPolicy = function (id, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.aclApiBaseUrl + '/subjects/' + id + '/policies',
                callback: callback
            });
        }
    ...
    *
    * @method deleteGroup
    * @param {int} groupId - group id in group_info returned by {@link module:webida.AuthService.createGroup}
    * @param {module:webida.request_callback} callback -
    *        (error:string|undefined) → undefined
    *        <br>If function finished successfully then error is undefined.
    * @memberOf module:webida.AuthService
    */
    mod.AuthService.prototype.deleteGroup = function (groupId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.groupApiBaseUrl + '/' + groupId,
                type: 'DELETE',
                callback: callback
            });
        }
    ...
    * @memberOf module:webida.AuthService
    */
    mod.AuthService.prototype.addUserToGroup = function (userId, groupId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.groupApiBaseUrl + '/groupusers',
                type: 'POST',
    ...
    * @memberOf module:webida.AuthService
    */
    mod.AuthService.prototype.addUsersToGroup = function (uidArr, groupId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.groupApiBaseUrl + '/groupusers',
                type: 'POST',
                data: { userId: uidArr.join(';'), groupId: groupId },
                callback: callback
            });
        }
    ...
    * @memberOf module:webida.AuthService
    */
    mod.AuthService.prototype.removeUserFromGroup = function (userId, groupId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.groupApiBaseUrl + '/groupusers',
                type: 'DELETE',
    ...
    * @memberOf module:webida.AuthService
    */
    mod.AuthService.prototype.removeUsersFromGroup = function (uidArr, groupId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.groupApiBaseUrl + '/groupusers',
                type: 'DELETE',
    ...
    */
    mod.AuthService.prototype.getAssignedGroups = function (callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.userApiBaseUrl + '/me/groups',
                callback: callback
            });
        }
    ...
    * @param {int} groupId - group id in group_info.
    * @param {module:webida.request_callback_with_user_info_list} callback -
    ...
    * @memberOf module:webida.AuthService
    */
    mod.AuthService.prototype.getGroupMembers = function (groupId, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.groupApiBaseUrl + '/' + groupId + '/users',
                callback: callback
            });
        }
    ...
    * @memberOf module:webida.AuthService
    */
    mod.AuthService.prototype.setGroupMembers = function (groupId, uidArr, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.groupApiBaseUrl + '/groupusers',
                type: 'POST',
                data: { groupId: groupId, userId: uidArr.join(';') },
                callback: callback
            });
        }
