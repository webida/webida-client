...
(function (root, factory) {
    ...
    */
    ...
    mod.AuthService.prototype.uipSignup = function (userArr, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.authApiBaseUrl + '/uipsignup',
                type: 'POST',
                data: { data: JSON.stringify(userArr) },
                callback: callback
            });
        }
    ...
    */
    ...
    mod.AuthService.prototype.uipUpdateUser = function (user, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.authApiBaseUrl + '/uipupdateuser/',
                type: 'POST',
                data: user,
                callback: callback
            });
    ...
    */
    ...
    mod.AuthService.prototype.uipDeleteGroup = function (gid, callback) {
        function restApi() {
            ajaxCall({
                url: mod.conf.groupApiBaseUrl + '/uipdeletegroup/',
                data: { gid: gid },
                callback: callback,
            });
        }
