...
define(['dijit/Dialog',
...
], function (Dialog, TextBox, registry, Tree, dndSource, ObjectStoreModel, aspect,
             declare,  Memory, Observable, pathUtil, template) {
    'use strict';
    ...
    //function initializeTree(root, initialSelection, singular, dirOnly) {
    function initializeTree(ops, idPostfix) {
        ...
        var tree = new Tree({
            ...
            expandTo: function (item, relPath, cb, eb) {
                ...
                var self = this;
                item.fetchChildren(ops.mount, ops.dirOnly, ops.filter,
                                   ops.hideSystemResources, function () {
                    if (i > 0) {
            ...
            selectInitialNodes: function () {
                ...
                function notifyOnePathSucc() {
                    doneCnt++;
                    if (doneCnt === ops.initialSelection.length) {
                        selectInitialNodes();
                    }
                }
                ...
                function selectInitialNodes() {
                    var arr = [];
                    ops.initialSelection.forEach(function (path) {
                ...
                ops.initialSelection.forEach(function (id) {
        ...
        tree.onOpen = function (item) {
            ...
            item.fetchChildren(ops.mount, ops.dirOnly, ops.filter, ops.hideSystemResources, function (alreadyFetched) {
                if (alreadyFetched) {
        ...
        constructor: function (ops) {
            /*
                ops = {
                    ...
                    initialSelection : [string (absolute path)],
                    singular: boolean,
                    dirOnly: boolean,
                    title: string
                }
            ...
            // Error checks of mount, root, and initialSelection, and
            // default values of initialSelection, singular, dirOnly, and title
            checkOptions(ops);
