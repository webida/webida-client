...
define([
    'dojo/text!./workspaceSelectionDialog.html',
    'dijit/registry',
    'dojo/dom-construct',
    ...
    'dijit/form/Select',
    'src/app'
], function(markup, registry, domConstruct, ObjectStore, Memory, Dialog, ButtonedDialog, Select, app) {
    'use strict';
    var dialog;
    var selectWidget;
    ...
    function getCandidates() {
        fsCache.list('/', false, function(err, stats) {
            var dirStats = stats.filter(function(stat) {
