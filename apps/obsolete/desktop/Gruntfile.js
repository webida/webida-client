...
module.exports = function (grunt) {
        ...
        copy: {
            ...
            uncompressed: {
                files: [{
                    expand: true,
                    cwd: './',
                    src: ['*.js', '**/*.js', '!script/lib/**', '!node_modules/**', '!deploy/**'],
                    dest: 'deploy/',
            ...
            debug: {
                ...
                files: [{
                    ...
                    src: ['*.js', '**/*.js', '!node_modules/*.js', '!node_modules/**/*.js',
                        '!script/lib/**/*.js', '!script/lib/*.js', '!*.uncompressed.js',
                        '!**/*.uncompressed.js'
                    ],
                    dest: 'deploy/'
                }]
    ...
    grunt.registerMultiTask('fixSourceMaps', 'Fixes uglified source maps', function () {
        this.files.forEach(function (f) {
            ...
            for (var i = 0; i < length; i++) {
                ...
                json.sources[i] = json.sources[i].substring(0, json.sources[i].lastIndexOf('.js')) +
                    '.uncompressed.js';
            }
    ...
    grunt.registerTask('default', ['clean:all', 'copy:all', 'copy:uncompressed', 'clean:unnecessary',
        'uglify:debug', 'fixSourceMaps'
    ]);
