...
define([
    ...
    'webida-lib/util/loading-screen'
], function(brInfo, loadingScreen, /*webida, msgAgent,*/ _, toastr, pm, /*FSCache,*/ URI, PopupDialog, topic, lang) {
    'use strict';
    ...
    function saveStatusSync() {
        ...
        if (statusString) {
            ...
            var blob = new Blob([statusString], {
