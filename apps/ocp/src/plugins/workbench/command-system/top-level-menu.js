...
define([
...
], function(_, dojo, on, reg, Menu, MenuItem, CheckedMenuItem, RadioMenuItem, PopupMenuItem, MenuBar, PopupMenuBarItem, MenuBarItem, DropDownMenu, MenuSeparator) {
    'use strict';
                ...
                switch (type) {
                    ...
                    case 'enum':
                        ...
                        if (disabledItems) {
                            ...
                            disabledItems.forEach(function(i) {
    ...
    function createTopLevelMenu(declaredItems) {
        ...
        _.each(declaredItems, function(item, itemName) {
            ...
            var id = '/' + itemName;
            var menuItem = new PopupMenuBarItem({
                label: label,
                id: id
            });
