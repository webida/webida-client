...
Parser.prototype.onopentagend = function(){
	...
	if(this._attribs){
		if(this._cbs.onopentag) this._cbs.onopentag(this._tagname, this._attribs, this.startIndex, this.endIndex);
		this._attribs = null;
	}
	...
	if(this._stack.length && (!(name in voidElements) || this._options.xmlMode)){
		...
		if(pos !== -1){
			if(this._cbs.onclosetag){
				...
				while(pos--) this._cbs.onclosetag(this._stack.pop(), this.startIndex, this.endIndex);
			}
