                ...
                files: [
                    {
                        expand: true,
                        cwd: 'deploy/',
                        src: ['*.js', '**/*.js', '!node_modules/*.js', '!node_modules/**/*.js', '!script/lib/**/*.js', '!script/lib/*.js', '!*.uncompressed.js', '!**/*.uncompressed.js'],
                        dest: 'deploy/'
                    }
                ]
            },
                ...
                files: [
                    {
                        expand: true,
                        cwd: 'deploy/',
                        src: ['*.js', '**/*.js', '!node_modules/**/*.js', '!node_modules/*.js', '!script/lib/**/*.js', '!script/lib/*.js'],
                        dest: 'deploy/'
                    }
                ]
            }
