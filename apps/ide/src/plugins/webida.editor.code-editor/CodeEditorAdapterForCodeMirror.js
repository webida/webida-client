...
define([
    ...
    function CodeEditorAdapterForCodeMirror(elem, file, startedListener) {
    ...
    gene.inherit(CodeEditorAdapterForCodeMirror, TextEditorAdapterForCodeMirror, {
        ...
        //TODO : inherit from TextEditorAdapterForCodeMirror
        /**
	     * @override
	     */
                                ...
                                if ((typeof this.linters[this.mode]) === 'object') {
                                    ...
                                    this.editor.setOption('lint', {
                                        ...
                                        getAnnotations: function (editorValue, updateLinting, passOptions, editor) {
                                            CodeEditorAdapterForCodeMirror.jsHintWorker(editorValue, jshintrc, function (data) {
                                    ...
                                    this.editor.setOption('lint', {
                                        async: true,
                                        getAnnotations: function (editorValue, updateLinting, passOptions, editor) {
                                            CodeEditorAdapterForCodeMirror.jsHintWorker(editorValue, false, function (data) {
                                                updateLinting(editor, data.annotations);
                                            });
                                        }
                                    });
    ...
    CodeEditorAdapterForCodeMirror._whitespaceOverlay = {
    ...
    CodeEditorAdapterForCodeMirror.getEnclosingDOMElem = function () {
        return document.getElementById('editor');
    };

    CodeEditorAdapterForCodeMirror.getShortcuts = function () {
        return [
    ...
    CodeEditorAdapterForCodeMirror.jsHintWorker = (function () {
        var listeners = {};
        var worker = null;
    ...
    CodeEditorAdapterForCodeMirror.getAvailableModes = function () {
        return [
            'js', 'json', 'ts', 'html', 'css', 'less'
        ];
    };
    CodeEditorAdapterForCodeMirror.getAvailableThemes = function () {
        return [
    ...
    CodeEditorAdapterForCodeMirror.getAvailableKeymaps = function () {
        return ['default', 'vim', 'emacs'];
    };

    return CodeEditorAdapterForCodeMirror;
});
