...
define(['require',
    ...
    function (require, Logger, CodeMirror, assist) {
        'use strict';
        ...
        function getHint(cm, callback, options) {
            ...
            assist.send(
                {mode: server.mode, type: 'request', server: null,
                    body: {
                        type: 'completions',
        ...
        server.startServer = function (filepath, cm, option, c) {
            ...
            cm.on('cursorActivity', function () { updateArgHints(cm); });
