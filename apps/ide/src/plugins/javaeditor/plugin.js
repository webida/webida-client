...
define(['other-lib/underscore/lodash.min',
    ...
    var preferenceFields = {
        'javaeditor:cm-theme': ['setTheme', 'webida-dark'],
        'javaeditor:invisibles': ['setShowInvisibles'],
        'javaeditor:folding': ['setCodeFolding', true],
        'javaeditor:activeline': ['setStyleActiveLine', true],
        // 'javaeditor:gutterline': ['setHighlightGutterLine', true],
        // 'javaeditor:indentguides': ['setDisplayIndentGuides', true],
        'javaeditor:highlightselection': ['setHighlightSelection', true],
        'javaeditor:wordWrap': ['setLineWrapping', false],
        'javaeditor:indentWithTabs' : ['setIndentWithTabs', false],
        'javaeditor:indentunit': ['setIndentUnit', 4],
        'javaeditor:indentOnPaste' : ['setIndentOnPaste', true],
        'javaeditor:tabsize': ['setTabSize', 4],
        'javaeditor:trimTrailing': ['setTrimTrailingWhitespaces', false],
        'javaeditor:insertFinal': ['setInsertFinalNewLine', false],
        'javaeditor:retabIndentations': ['setRetabIndentations', false],
        'javaeditor:font': ['setFontFamily', 'Nanum Gothic Coding'],
        'javaeditor:fontSize': ['setFontSize', 13],
        'javaeditor:keymap': ['setKeymap', 'default'],
        'javaeditor:enableSnippet': ['setSnippetEnabled', true],
        'javaeditor:lineNumbers': ['setShowLineNumbers', true],

        // content assist
        'javaeditor:autoCompletion': ['setAutoCompletion', true],
        'javaeditor:autoCompletionDelay': ['setAutoCompletionDelay', 0.3],
        'javaeditor:anywordHint': ['setAnywordHint', false]
    };
    ...
    var self = {
        create: function (file, content, elem, started) {
            ...
            if (file.__elemId === undefined) {
                ...
                if (store.getValue('javaeditor:editorconfig') === true) {
                    configloader.editorconfig(instance, file);
                }
                if (store.getValue('javaeditor:jshintrc') !== false) {
