...
// @formatter:off
define([
    'external/codemirror/addon/hint/xml-hint',
...
// @formatter:on
    ...
    function HtmlDefaultControl(viewer, cm, options, c) {
        logger.info('new HtmlDefaultControl()');   
    ...
    genetic.inherits(HtmlDefaultControl, IContentAssist, {
