...
define(['text!./entities/entities.json', 'text!./entities/legacy.json', 'text!./entities/xml.json', 'text!./entities/decode.json'],
       function (entitiesJson, legacyJson, xmlJson, decodeJson) {
...
*/
var entityMap = JSON.parse(entitiesJson),
    legacyMap = JSON.parse(legacyJson),
    xmlMap = JSON.parse(xmlJson),
    decodeMap = JSON.parse(decodeJson),
